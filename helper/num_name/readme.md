...
Каждая лаборатория имеет электронный журнал регистрации поверочных работ (файл .xlsx на сервере подразделенеия), в котором хранится информация о выполняемой работе:
