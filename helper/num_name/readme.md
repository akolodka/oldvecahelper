...
Представление пользовательской формы изменяется в зависимости от типа активного файла Excel: наибольший функционал доступен при выполнении поверочной работы. 
