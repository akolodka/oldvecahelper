...
![Title](https://github.com/akolodka/VBA/blob/main/resources/databaseOld_Constructor.jpg)
...
Для быстрого перехода применяется поиск независимо от языка ввода аналогично основной поисковой форме.

Идея вставки текстовых данных в поля активной книги Excel была дополнена предварительной загрузкой файла-шаблона Excel из индивидуального каталога данных для конкретного средства измерений.
