...
Представление пользовательской формы изменяется в зависимости от типа выполняемой работы: для поверочной работы доступно наиболее количество элементов управления.

Пользовательская форма при запуске в файле Excel, не относящимся к одному из трёх типов работ:
