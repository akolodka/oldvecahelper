...
## P.s.
Пока писал этот readme, обнаружил неточности в логике. Вместе с тем, наибольшее применение библиотека нашла в распространении обновлений для Excel, что выполняется корректно и не оказывает значимого влияния на работу других проектов.
