...
База данных контрагентов применяется, в первую очередь, для передачи сведений контагентов в файл-шаблон обработки данных Excel:
- в подготовленные ячейки;
- в свойство книги Excel.

По умолчанию передача данных найденного контрагента выполняется по нажатию на Enter. 
