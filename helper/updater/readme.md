...
Операции установки:
- повторение п.1 — п. 4 проверки доступности обновлений для каждого файла в каталоге обновлений;
...
После чего приложение Office благополучено закрывается, а при следующем запуске будет загружена новая версия библиотеки.
