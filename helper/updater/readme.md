...
Доступность обновлений проверяется либо при запуске пользовательского меню настроек, либо через событие Workbook_Open().
Установлено ограничение на проверку обновлений не более раз в сутки, запись о дате проверки помещается в кеш-файл.
