...
- таблица из файла данных;
- таблица соответствия символов английской и русской раскладки клавиатуры (q = й, w = ц и т.д.);
- последний поисковый запрос;
- последняя выбранная позиция в списке результатов поиска (ListBox).
