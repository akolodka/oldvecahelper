...
## P.s.
Пока писал этот readme, обнаружил ошибки и неточности в логике работы. 
Вместе с тем, наибольшее применение библиотека нашла в обновлении для Excel, что не оказывает значимого влияния на работу.
